        ...
        "serverRequest/resolved" -> {
            ...
            if (payload != null) {
                CodexNotification.ServerRequestResolved(
                    threadId = payload.threadId,
                    requestId = payload.requestId.toCodexServerRequestId(),
                )
            } else {
                CodexNotification.Unknown(method)
            }
...
private fun JsonRpcId.toCodexServerRequestId(): CodexServerRequestId = when (this) {
    is JsonRpcId.Number -> CodexServerRequestId.Number(value)
    is JsonRpcId.StringId -> CodexServerRequestId.StringId(value)
}
